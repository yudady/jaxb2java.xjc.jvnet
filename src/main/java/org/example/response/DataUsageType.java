 ...
 * 使用量
 * 
 * <p>DataUsageType complex type 的 Java 類別.
 * 
 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://www.example.org/common&gt;AmountType"&gt;
 *       &lt;attribute name="Unit"&gt;
 *         &lt;simpleType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DataUsageType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DataUsageType that = ((DataUsageType) object);
        {
            double lhsValue;
